fun box(): String {
    ...
    val i1 = iarg1 and iarg2
    val i2 = iarg1 or  iarg2
    val i3 = iarg1 xor iarg2
    val i4 = iarg1.inv()
    val i5 = iarg1 shl 16
    val i6 = iarg1 shr 16
    val i7 = iarg1 ushr 16
    ...
    val l1 = larg1 and larg2
    val l2 = larg1 or  larg2
    val l3 = larg1 xor larg2
    val l4 = larg1.inv()
    val l5 = larg1 shl 32
    val l6 = larg1 shr 32
    val l7 = larg1 ushr 32
    ...
    val s1 = sarg1 and sarg2
    val s2 = sarg1 or  sarg2
    val s3 = sarg1 xor sarg2
    val s4 = sarg1.inv()
    val s5 = sarg1 shl 8
    val s6 = sarg1 shr 8
    val s7 = sarg1 ushr 8
    ...
    val b1 = barg1 and barg2
    val b2 = barg1 or  barg2
    val b3 = barg1 xor barg2
    val b4 = barg1.inv()
    val b5 = barg1 shl 4
    val b6 = barg1 shr 4
    val b7 = barg1 ushr 4
