fun box(): String {
    ...
    val i1: Int? = iarg1 and iarg2
    val i2: Int? = iarg1 or  iarg2
    val i3: Int? = iarg1 xor iarg2
    val i4: Int? = iarg1.inv()
    val i5: Int? = iarg1 shl 16
    val i6: Int? = iarg1 shr 16
    val i7: Int? = iarg1 ushr 16
    ...
    val l1: Long? = larg1 and larg2
    val l2: Long? = larg1 or  larg2
    val l3: Long? = larg1 xor larg2
    val l4: Long? = larg1.inv()
    val l5: Long? = larg1 shl 32
    val l6: Long? = larg1 shr 32
    val l7: Long? = larg1 ushr 32
    ...
    val s1: Short? = sarg1 and sarg2
    val s2: Short? = sarg1 or  sarg2
    val s3: Short? = sarg1 xor sarg2
    val s4: Short? = sarg1.inv()
    val s5: Short? = sarg1 shl 8
    val s6: Short? = sarg1 shr 8
    val s7: Short? = sarg1 ushr 8
    ...
    val b1: Byte? = barg1 and barg2
    val b2: Byte? = barg1 or  barg2
    val b3: Byte? = barg1 xor barg2
    val b4: Byte? = barg1.inv()
    val b5: Byte? = barg1 shl 4
    val b6: Byte? = barg1 shr 4
    val b7: Byte? = barg1 ushr 4
